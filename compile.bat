...
g++ src\main.cpp src\ParticleSystem.cpp src\Particle.cpp src\Mousart.cpp src\TextureManager.cpp -o ParticleSimulator -lsfml-graphics -lsfml-window -lsfml-system
if %ERRORLEVEL% == 0 (
